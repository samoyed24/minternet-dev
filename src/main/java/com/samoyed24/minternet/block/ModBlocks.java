...
public class ModBlocks {
    public static final Block SERVER = register("server", new Block(AbstractBlock.Settings.create().strength(3.0f, 3.0f)));
    public static final Block ROUTER = register("router", new Block(AbstractBlock.Settings.create().strength(3.0f, 3.0f)));
